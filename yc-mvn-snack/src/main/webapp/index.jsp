		...
		<form name=alipayment action=alipay.trade.page.pay.jsp method=post
			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					<dt>订单名称 ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject"  v-model="pname" readonly="readonly"/>
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
...
<script type="text/javascript" src="静态页面(7.10sql)/js/jquery-3.4.1.min.js"></script>
<script type="text/javascript" src="静态页面(7.10sql)/js/vue.min.js"></script>
